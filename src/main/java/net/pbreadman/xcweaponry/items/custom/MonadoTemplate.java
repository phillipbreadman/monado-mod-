...
public class MonadoTemplate extends SmithingTemplateItem {
    ...
    static {
        MONADO_UPGRADE_APPLIES_TO = Component.translatable(Util.makeDescriptionId("item", ResourceLocation.fromNamespaceAndPath("xcweaponry", "smithing_template.monado_upgrade.applies_to"))).withStyle(DESCRIPTION_FORMAT);
        MONADO_UPGRADE_INGREDIENTS = Component.translatable(Util.makeDescriptionId("item", ResourceLocation.fromNamespaceAndPath("xcweaponry", "smithing_template.monado_upgrade.ingredients"))).withStyle(DESCRIPTION_FORMAT);
        MONADO_UPGRADE = Component.translatable(Util.makeDescriptionId("upgrade", ResourceLocation.fromNamespaceAndPath("xcweaponry", "monado_upgrade"))).withStyle(TITLE_FORMAT);
        MONADO_UPGRADE_BASE_SLOT_DESCRIPTION = Component.translatable(Util.makeDescriptionId("item", ResourceLocation.fromNamespaceAndPath("xcweaponry", "smithing_template.monado_upgrade.base_slot_description")));
        MONADO_UPGRADE_ADDITIONS_SLOT_DESCRIPTION = Component.translatable(Util.makeDescriptionId("item", ResourceLocation.fromNamespaceAndPath("xcweaponry", "smithing_template.monado_upgrade.additions_slot_description")));
